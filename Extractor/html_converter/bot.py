    ...
    <head>
        ...
        <style>
            ...
            .brand-title {{ 
                ...
                font-weight: 900;
                background: linear-gradient(45deg, #8b5cf6, #ec4899, #22c55e);
...
<a href="https://t.me/courses_hub2_bot" target="_blank" style="text-decoration: none; color: inherit;">
...
<a href="https://t.me/+b6Xmaaj6Yq84YTdh" style="text-decoration: none; color: inherit;">
  <span class="badge me-2" style="background:linear-gradient(45deg,#8b5cf6,#ec4899);color:white;padding:8px 14px;border-radius:20px;font-weight:600;">
    <i class="fas fa-robot"></i> Join @courses_hub2_bot
  </span>
</a>
