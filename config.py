...
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7996096550:AAFLQ3ge0iqfm1STzCmpFvXk8cqHFP2re5g")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@UGExtractorBot")
BOT_TEXT = "UG Extractor"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "7958597957"))
# ------------------------------------------------
# //LOG CHANNEL ID 
...
# -----------------------------------------------
join = '<a href="https://t.me/UGxUltra">✳️ JOIN BACKUP</a>'
# -----------------------------------------------
